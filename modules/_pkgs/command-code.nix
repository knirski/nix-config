...
buildNpmPackage rec {
  ...
  src = fetchurl {
    ...
    hash = "sha512-l+q95jhhwhTxj+UPhCSUsu+ypHbONzSGtWqSPoAB9L3rFvnuf1OLni9roZVsqfbMU6y6Weq+rxCObCrWLB+hfQ==";
  };
  ...
  npmDepsHash = "sha256-yB8mETZq8jDHywFMqxG/z4yaRqoxn2CLPk+L+y+tTPc=";
