      ...
      wayland.windowManager.sway = {
        ...
        config = rec {
          ...
          keybindings = {
            ...
            "Ctrl+Print" =
              "exec bash -c 'f=~/Pictures/Screenshots/screenshot-$(date +%Y%m%d-%H%M%S).png && mkdir -p \"$(dirname \"$f\")\" && grim \"$f\" && notify-send \"Screenshot saved: $f\"'";
            "${modifier}+Shift+s" =
              "exec bash -c 'f=~/Pictures/Screenshots/screenshot-$(date +%Y%m%d-%H%M%S).png && mkdir -p \"$(dirname \"$f\")\" && grim -g \"$(slurp)\" \"$f\" && notify-send \"Screenshot saved: $f\"'";
