setup_contract_test() {
  ...
  unset SSH_FAIL_PATTERN SSH_FAIL_OUTPUT SSH_FAIL_STATUS SSH_ROLE_MARKER SSH_APPLIANCE_FALLBACK SSH_HOSTNAME SSH_PLATFORM_NAME SSH_OS_RELEASE RAGE_FAIL_PATTERN NIX_STUB_STATUS NIX_STUB_OUTPUT NIX_STUB_MUTATE_REKEYED \
