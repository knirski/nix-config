setup_contract_test() {
  ...
  unset SSH_FAIL_PATTERN SSH_FAIL_OUTPUT SSH_FAIL_STATUS SSH_ROLE_MARKER SSH_APPLIANCE_FALLBACK SSH_HOSTNAME SSH_PLATFORM_NAME SSH_OS_RELEASE SSH_LAN_IP RAGE_FAIL_PATTERN NIX_STUB_STATUS NIX_STUB_OUTPUT NIX_STUB_MUTATE_REKEYED \
    BACKUP_STATE_BTRBK_SOYO BACKUP_STATE_RESTIC_SOYO BACKUP_STATE_BTRBK_ZBOOK BACKUP_STATE_RESTIC_ZBOOK BLACKBOX_ICMP_STATE BLACKBOX_HTTP_STATE \
    NVIDIA_PM_STATE NVIDIA_HUNG_STATE
}
